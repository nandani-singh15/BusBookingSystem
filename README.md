...
This is a small desktop application I made for my flipped course project. 
The idea was to build something simple where a user can book a bus ticket, 
check the booked tickets, and cancel them if needed. I used basic Core Java 
and Swing because we were asked to use the concepts taught in class.
...
## Why I chose this
I wanted to make something simple but useful, and I thought a bus ticket 
booking idea would be easy to implement using Swing and file handling.
...
3. Compile the file using:
   javac AdvancedBusBookingSystem.java
4. Then run it using:
   java AdvancedBusBookingSystem
